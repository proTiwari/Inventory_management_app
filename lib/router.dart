...
class AppRoutes {
  ...
  static const String consumeractivity = '/consumeractivity';
  ...
  static final List<GetPage> routes = [
    ...
    GetPage(name: consumeractivity, page: () => ConsumerActivitylistWidget())
    // ConsumerActivitylistWidget
  ];
}
